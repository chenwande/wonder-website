"use strict";(self.webpackChunkwonder=self.webpackChunkwonder||[]).push([[392],{66768:function(u,a,t){var m;t.r(a),t.d(a,{demos:function(){return r}});var c=t(90228),p=t.n(c),x=t(87999),d=t.n(x),_=t(75271),v=t(61384),h=t(74908),r={"src-canvas-demo-demo":{component:_.memo(_.lazy(function(){return Promise.all([t.e(847),t.e(433)]).then(t.bind(t,26878))})),asset:{type:"BLOCK",id:"src-canvas-demo-demo",refAtomIds:[],dependencies:{"index.tsx":{type:"FILE",value:t(16478).Z},react:{type:"NPM",value:"18.3.1"},"./utils.ts":{type:"FILE",value:t(65537).Z}},entry:"index.tsx"},context:{"./utils.ts":h,react:m||(m=t.t(_,2)),"/Users/chenwande/test/wonder/src/canvas/utils.ts":h},renderOpts:{compile:function(){var e=d()(p()().mark(function n(){var s,l=arguments;return p()().wrap(function(o){for(;;)switch(o.prev=o.next){case 0:return o.next=2,t.e(223).then(t.bind(t,61223));case 2:return o.abrupt("return",(s=o.sent).default.apply(s,l));case 3:case"end":return o.stop()}},n)}));function i(){return e.apply(this,arguments)}return i}()}}}},74908:function(u,a,t){t.r(a),t.d(a,{Graph:function(){return v},Point:function(){return _},getRandom:function(){return d}});var m=t(25298),c=t.n(m),p=t(17069),x=t.n(p),d=function(r,e){return Math.random()*(e-r)+r},_=function(){function h(r,e){c()(this,h),this.ctx=r,this.canvas=e,this.r=4,this.x=d(0,e.width-this.r/2),this.y=d(0,e.height-this.r/2),this.xSpeed=d(-50,50),this.ySpeed=d(-50,50),this.lastDrawTime=null}return x()(h,[{key:"draw",value:function(){if(!this.lastDrawTime)this.lastDrawTime=Date.now();else{var e=Date.now(),i=(e-this.lastDrawTime)/1e3,n=this.x+this.xSpeed*i,s=this.y+this.ySpeed*i;n<0?(n=0,this.xSpeed=-this.xSpeed):n>this.canvas.width-this.r/2&&(n=this.canvas.width-this.r/2,this.xSpeed=-this.xSpeed),s<0?(s=0,this.ySpeed=-this.ySpeed):s>this.canvas.height-this.r/2&&(s=this.canvas.height-this.r/2,this.ySpeed=-this.ySpeed),this.x=n,this.y=s,this.lastDrawTime=e}this.ctx.beginPath(),this.ctx.arc(this.x,this.y,this.r,0,Math.PI*2),this.ctx.fillStyle="rgb(200, 200, 200)",this.ctx.fill()}}]),h}(),v=function(){function h(r,e){var i=this,n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:40,s=arguments.length>3&&arguments[3]!==void 0?arguments[3]:300;c()(this,h),this.canvas=e,this.ctx=r,this.points=Array(n).fill(0).map(function(){return new _(i.ctx,i.canvas)}),this.maxDistance=s,this.draw()}return x()(h,[{key:"draw",value:function(){var e=this;requestAnimationFrame(function(){e.draw()}),this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height);for(var i=0;i<this.points.length;i++){var n=this.points[i];n.draw();for(var s=i+1;s<this.points.length;s++){var l=this.points[s],f=Math.sqrt(Math.pow(n.x-l.x,2)+Math.pow(n.y-l.y,2)),o=1-f/this.maxDistance;this.ctx.beginPath(),this.ctx.moveTo(n.x,n.y),this.ctx.lineTo(l.x,l.y),this.ctx.strokeStyle="rgba(200, 200, 200, ".concat(o,")"),this.ctx.stroke()}}}}]),h}()},11515:function(u,a,t){t.r(a),t.d(a,{texts:function(){return c}});var m=t(61384);const c=[]},16478:function(u,a){a.Z=`import React, { useEffect } from 'react';
...
export default Demo;
`},65537:function(u,a){a.Z=`// @ts-nocheck
